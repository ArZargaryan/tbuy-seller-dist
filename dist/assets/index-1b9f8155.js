import{a4 as u,a5 as l,k as x,a as d,X as g,j as e,h,n as t,e as f,a7 as v,i as w,a8 as b,a2 as y,b8 as j,b9 as S,ba as z,L as F}from"./index-c419738b.js";import{g as C}from"./date-utils-e9a3739c.js";const i=u({handler:async a=>x.post("/client/forgot-password",{...a}).then(s=>s.data)});i.finished.success.watch(({result:a})=>{l("Success",{description:a.message,className:"success-toast"})});i.finished.failure.watch(({error:a})=>{const s=a.response.data;l("Error",{description:s.message,className:"error-toast"})});const k=({email:a,disabled:s})=>{const{t:n}=d(),{start:c,pending:o}=g(i),r=()=>{};return e.jsx(h,{type:"submit",onClick:r,large:"S",stretched:!0,appearance:"white",variant:"primary",disabled:s||o,style:{width:"auto",padding:"0 50px"},children:n("Get password")})},P=t.form`
